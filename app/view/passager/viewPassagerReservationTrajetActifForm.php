...
<body>
    <div class="container">
        ...
        ?> 
        <h1>Sélectionnez l'un des trajets actifs pour vous réserver une place</h1>
    </p>
    <form method="post" action="../../app/router/router1.php?action=passagerReserverTrajetActifAction">
